  ...
  const menuData = {
    ...
    cocktail: {
      ...
      items: [
        ...
        { id: 73, name: "TEQUILA SUNRISE", description: "TEQUILA, ORANGE JUICE & GRENADINE", price: 10000, type: "single", image: "https://www.liquor.com/thmb/oWq-2scokVB56sgAYk3ksulN33Y=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/tequila-sunrise-1500x785-twitter-a6d1393909b843598a682808f94d3065.jpg" },
        { id: 74, name: "MARGARITA", description: "TEQUILA, TRIPLE SEC & LIME JUICE", price: 12000, type: "single", image: "https://filodeagave.com/wp-content/uploads/2024/05/Classic-Margarita-Recipe-with-Tequila-Filo-de-Agave-Blanco-v002.jpg" },
        { id: 75, name: "PINA COLADA", description: "RUM, COCONUT CREAM & PINEAPPLE JUICE", price: 13000, type: "single", image: "https://cdn.apartmenttherapy.info/image/upload/f_jpg,q_auto:eco,c_fill,g_auto,w_1500,ar_1:1/k%2FPhoto%2FRecipes%2F2024-07-pina-colada%2Fpina-colada-177" },
        { id: 76, name: "BLUE LAGOON", description: "VODKA, BLUE CURACAO & LEMONADE", price: 11000, type: "single", image: "https://frobishers.com/cdn/shop/articles/Screenshot_2024-08-16_at_12.55.17.png?v=1724236070" },
        { id: 77, name: "SEX ON THE BEACH", description: "VODKA, PEACH SCHNAPPS & JUICES", price: 12500, type: "single", image: "https://hips.hearstapps.com/hmg-prod/images/sex-on-the-beach-index-6442f7c402c66.jpg?crop=0.888888888888889xw:1xh;center,top&resize=1200:*" },
        { id: 78, name: "MOJITO", description: "RUM, MINT, LIME & SODA", price: 9000, type: "single", image: "https://assets.malibudrinks.com/wp-content/uploads/2024/02/Malibu-Mojito-16x9-2-scaled.jpg?tr=q-80,w-2560" },
        { id: 79, name: "WHISKEY SOUR", description: "WHISKEY, LEMON JUICE & SUGAR", price: 11000, type: "single", image: "https://cdn.apartmenttherapy.info/image/upload/f_jpg,q_auto:eco,c_fill,g_auto,w_1500,ar_4:3/k%2FPhoto%2FRecipes%2F2024-03-whiskey-sour%2Fwhiskey-sour-699_1" },
        { id: 80, name: "LONG ISLAND ICED TEA", description: "VODKA, RUM, GIN, TEQUILA & COLA", price: 16000, type: "single", image: "https://food.fnr.sndimg.com/content/dam/images/food/fullset/2011/4/25/0/CCWM_Long-Island-Ice-Tea_s3x4.jpg.rend.hgtvcom.1280.960.suffix/1572356786983.webp" },
        { id: 81, name: "DAIQUIRI", description: "RUM, LIME JUICE & SUGAR", price: 9500, type: "single", image: "https://www.thebottleclub.com/cdn/shop/articles/TBC_recipe_image_11-436716.jpg?v=1707230647" },
        { id: 82, name: "MANHATTAN", description: "WHISKEY, SWEET VERMOUTH & BITTERS", price: 14000, type: "single", image: "https://cdn.loveandlemons.com/wp-content/uploads/2025/02/manhattan-drink.jpg" }
      ]
    },
    food: {
      title: "FOOD",
      ...
      items: [
        ...
        { id: 87, name: "UMUSHISHIRO", price: 2000, type: "single", image: "https://www.newtimes.co.rw/uploads/imported_images/files/main/articles/2013/05/04/1367702494brochettes.jpg" },
        { id: 88, name: "BANANA MILK SHAKE", price: 5000, type: "single", image: "https://foodtasia.com/wp-content/uploads/2021/07/banana-milkshake-34.jpg" },
        { id: 89, name: "CARAMEL MILK SHAKE", price: 5000, type: "single", image: "https://amandascookin.com/wp-content/uploads/2021/06/salted-caramel-milkshake-RC-SQ.jpg" },
        { id: 90, name: "BUTTER SCOTCH", price: 5000, type: "single", image: "https://bakewithshivesh.com/wp-content/uploads/2021/07/image-scaled.jpg" },
        { id: 91, name: "CHOCOLATE MILK SHAKE", price: 5000, type: "single", image: "https://brooklynfarmgirl.com/wp-content/uploads/2021/03/The-Best-Chocolate-Milkshake-Featured-Image.jpg" },
        { id: 92, name: "STRAWBERRY MILK SHAKE", price: 5000, type: "single", image: "https://minimalistbaker.com/wp-content/uploads/2022/04/Strawberry-Milkshake-SQUARE.jpg" },
        { id: 93, name: "VANILLA MILK SHAKE", price: 5000, type: "single", image: "https://www.allrecipes.com/thmb/uzxCGTc-5WCUZnZ7BUcYcmWKxjo=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/AR-48974-vanilla-milkshake-hero-4x3-c815295c714f41f6b17b104e7403a53b.jpg" },
        { id: 94, name: "GRILLED CHICKEN", price: 8000, type: "single", image: "https://www.spiceindiaonline.com/wp-content/uploads/2021/05/Tandoori-Chicken-20-500x400.jpg" },
        { id: 95, name: "GOAT MEAT PLATE", price: 12000, type: "single", image: "https://i.ytimg.com/vi/Z5om96jjvjA/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLD9KAclM5STZq1Tsm7TnpZOHXDEJQ" },
        { id: 96, name: "FISH PLATE", price: 15000, type: "single", image: "https://thumbs.dreamstime.com/b/grilled-fish-plate-freshly-caught-fish-served-sliced-tomatoes-lemons-perfect-casual-dining-scene-388256090.jpg" },
        { id: 97, name: "BEEF BURGER", price: 6000, type: "single", image: "https://www.unileverfoodsolutions.co.za/dam/global-ufs/mcos/SOUTH-AFRICA/calcmenu/recipes/ZA-recipes/general/beef-burger/main-header.jpg" },
        { id: 98, name: "CHICKEN BURGER", price: 5500, type: "single", image: "https://www.datocms-assets.com/129288/1725393944-moist-chicken-burgers.jpg" },
        { id: 99, name: "FRENCH FRIES", price: 3000, type: "single", image: "https://www.awesomecuisine.com/wp-content/uploads/2009/05/french-fries.jpg" },
        { id: 100, name: "ONION RINGS", price: 3500, type: "single", image: "https://smokinandgrillinwitab.com/wp-content/uploads/2025/02/iStock-2188707691-scaled.jpg" }
      ]
    }
  };

  // State for beer sub-subcategories
  const [activeBeerSubCategory, setActiveBeerSubCategory] = useState('blarirwa');
  ...
  const getCurrentItems = () => {
    ...
    if (activeCategory === 'drinks') {
      if (activeSubCategory === 'beers') {
        items = menuData.drinks.subCategories.beers.subSubCategories[activeBeerSubCategory].items;
      } else {
                ...
                >
                  <div className="flex space-x-2 overflow-x-auto pb-2">
                    {Object.keys(menuData.drinks.subCategories.beers.subSubCategories).map((beerSubCategory) => (
                      ...
                      >
                        {menuData.drinks.subCategories.beers.subSubCategories[beerSubCategory].title}
                      </button>
                    ))}
                  </div>
                </motion.div>
